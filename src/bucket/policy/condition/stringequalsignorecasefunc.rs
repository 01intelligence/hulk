...
mod tests {
    ...
    #[test]
    fn test_string_equals_ignore_case_func_evaluate() -> anyhow::Result<()> {
        let func1 = new_string_equals_ignore_case_func(
            S3X_AMZ_COPY_SOURCE,
            ValueSet::new(vec![Value::String("mybucket/myobject".to_string())]),
        )?;

        let func2 = new_string_equals_ignore_case_func(
            S3X_AMZ_SERVER_SIDE_ENCRYPTION,
            ValueSet::new(vec![Value::String("AES256".to_string())]),
        )?;

        let func3 = new_string_equals_ignore_case_func(
            S3X_AMZ_METADATA_DIRECTIVE,
            ValueSet::new(vec![Value::String("REPLACE".to_string())]),
        )?;

        let func4 = new_string_equals_ignore_case_func(
    ...
    #[test]
    fn test_string_equals_ignore_case_func_key() -> anyhow::Result<()> {
        let func1 = new_string_equals_ignore_case_func(
            S3X_AMZ_COPY_SOURCE,
            ValueSet::new(vec![Value::String("mybucket/myobject".to_string())]),
        )?;
    ...
    #[test]
    fn test_string_equals_ignore_case_func_to_map() -> anyhow::Result<()> {
        let func1 = new_string_equals_ignore_case_func(
            S3X_AMZ_COPY_SOURCE,
            ValueSet::new(vec![Value::String("mybucket/myobject".to_string())]),
        )?;
        ...
        let func5 = new_string_equals_ignore_case_func(
            S3X_AMZ_METADATA_DIRECTIVE,
            ValueSet::new(vec![
        ...
        let func6 = new_string_equals_ignore_case_func(
            S3_LOCATION_CONSTRAINT,
            ValueSet::new(vec![Value::String("eu-west-1".to_string())]),
        )?;
        ...
        let func7 = new_string_equals_ignore_case_func(
            S3_LOCATION_CONSTRAINT,
            ValueSet::new(vec![
    ...
    #[test]
    fn test_string_not_equals_ignore_case_func_evaluate() -> anyhow::Result<()> {
        let func1 = new_string_not_equals_ignore_case_func(
            S3X_AMZ_COPY_SOURCE,
            ValueSet::new(vec![Value::String("mybucket/myobject".to_string())]),
        )?;

        let func2 = new_string_not_equals_ignore_case_func(
            S3X_AMZ_SERVER_SIDE_ENCRYPTION,
            ValueSet::new(vec![Value::String("AES256".to_string())]),
        )?;

        let func3 = new_string_not_equals_ignore_case_func(
            S3X_AMZ_METADATA_DIRECTIVE,
            ValueSet::new(vec![Value::String("REPLACE".to_string())]),
        )?;

        let func4 = new_string_not_equals_ignore_case_func(
            S3_LOCATION_CONSTRAINT,
            ValueSet::new(vec![Value::String("eu-west-1".to_string())]),
        )?;
    ...
    #[test]
    fn test_string_not_equals_ignore_case_func_key() -> anyhow::Result<()> {
        let func1 = new_string_not_equals_ignore_case_func(
            S3X_AMZ_COPY_SOURCE,
            ValueSet::new(vec![Value::String("mybucket/myobject".to_string())]),
        )?;
    ...
    #[test]
    fn test_string_not_equals_ignore_case_func_to_map() -> anyhow::Result<()> {
        let func1 = new_string_not_equals_ignore_case_func(
            S3X_AMZ_COPY_SOURCE,
            ValueSet::new(vec![Value::String("mybucket/myobject".to_string())]),
        )?;
        ...
        let func5 = new_string_not_equals_ignore_case_func(
            S3X_AMZ_METADATA_DIRECTIVE,
            ValueSet::new(vec![
                Value::String("REPLACE".to_string()),
                Value::String("COPY".to_string()),
        ...
        let func6 = new_string_not_equals_ignore_case_func(
            S3_LOCATION_CONSTRAINT,
            ValueSet::new(vec![Value::String("eu-west-1".to_string())]),
        )?;
        ...
        let func7 = new_string_not_equals_ignore_case_func(
            S3_LOCATION_CONSTRAINT,
            ValueSet::new(vec![
                Value::String("eu-west-1".to_string()),
                Value::String("us-west-1".to_string()),
    ...
    #[test]
    fn test_new_string_equals_ignore_case_func() -> anyhow::Result<()> {
        let func1 = new_string_equals_ignore_case_func(
            S3X_AMZ_COPY_SOURCE,
            ValueSet::new(vec![Value::String("mybucket/myobject".to_string())]),
        )?;
        ...
        for (key, values, expected_result, expect_err) in cases {
            ...
            let result = new_string_equals_ignore_case_func(key, values);
    ...
    #[test]
    fn test_new_string_not_equals_ignore_case_func() -> anyhow::Result<()> {
        let func1 = new_string_not_equals_ignore_case_func(
            S3X_AMZ_COPY_SOURCE,
            ValueSet::new(vec![Value::String("mybucket/myobject".to_string())]),
        )?;
        ...
        for (key, values, expected_result, expect_err) in cases {
            let key_cache = key.clone();
            let result = new_string_not_equals_ignore_case_func(key, values);
