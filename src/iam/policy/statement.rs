...
impl<'a, 'b> PartialEq for Statement<'a, 'b> {
...
mod tests {
    ...
    fn test_statement_deserialize_json() -> anyhow::Result<()> {
        ...
        let cases = [
            ...
            // Invalid effect error.
            (data5, None, true, true),
            // Empty action error.
            (data6, None, true, true),
            // Empty resource error.
            (data7, None, true, true),
            // Empty condition error.
            (data8, None, true, false),
